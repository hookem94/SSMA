...
class PEScanner:
    def __init__(self, filename):
        ...
        self.alerts = {  # Practical Malware Analysis (2012) - Sikorski M., Honig A. AND Top 55 from https://www.bnxnet.com/top-maliciously-used-apis/
            ...
            'CharNextA': "Top 55 - Retrieves a pointer to the next character in a string. This function can handle strings consisting of either single- or multi-byte characters.",
            ...
            'CloseHandle': "Top 55 - Closes an open object handle.",
            ...
            'CreateThread': "Top 55 - Creates a thread to execute within the virtual address space of the calling proces.",
            ...
            'DeleteCriticalSection': "Top 55 - Releases all resources used by an unowned critical section object.",
            'DeleteFileA': "Top 55 - Deletes an existing file.",
            ...
            'EnterCriticalSection': "Top 55 - Waits for ownership of the specified critical section object. The function returns when the calling thread is granted ownership.",
            ...
            'ExitProcess': "Top 55 - Ends the calling process and all its threads.",
            'FindClose': "Top 55 - Closes a file search handle opened by the FindFirstFile, FindFirstFileEx, FindFirstFileNameW, FindFirstFileNameTransactedW, FindFirstFileTransacted, FindFirstStreamTransactedW, or FindFirstStreamW functions.",
            'FindFirstFile/FindNextFile': "Used to search through a directory and enumerate the filesystem.",
            'FindFirstFileA': "Top 55 - Searches a directory for a file or subdirectory with a name that matches a specific name (or partial name if wildcards are used).",
            ...
            'FreeLibrary': "Top 55 - Frees the loaded dynamic-link library (DLL) module and, if necessary, decrements its reference count. When the reference count reaches zero, the module is unloaded from the address space of the calling process and the handle is no longer valid.",
            'FtpPutFile': "A high-level function for uploading a file to a remote FTP server.",
            'GetACP': "Top 55 - Retrieves the current Windows ANSI code page identifier for the operating system.",
            ...
            'GetCommandLine': "Top 55 - Retrieves the command-line string for the current process.",
            'GetCPInfo': "Top 55 - Retrieves information about any valid installed or available code page.",
            'GetCurrentProcess': "Top 55 - Retrieves a pseudo handle for the current process.",
            'GetCurrentProcessId': "Top 55 - Retrieves the process identifier of the calling process.",
            'GetCurrentThreadId': "Top 55 - Retrieves the thread identifier of the calling thread.",
            'GetDC': "Top 55 - Returns a handle to a device context for a window or the whole screen. Spyware that takes screen captures often uses this function.",
            'GetFileSize': "Top 55 - Retrieves the size of the specified file, in bytes.",
            ...
            'GetLastError': "Top 55 - Retrieves the calling thread's last-error code value. The last-error code is maintained on a per-thread basis. Multiple threads do not overwrite each other's last-error code.",
            'GetLocaleInfoA': "Top 55 - Retrieves information about a locale specified by identifier.",
            'GetModuleFilename': "Top 55 - Returns the filename of a module that is loaded in the current process. Malware can use this function to modify or copy files in the currently running process.",
            'GetModuleHandle': "Top 55 - Used to obtain a handle to an already loaded module. Malware may use GetModuleHandle to locate and modify code in a loaded module or to search for a good location to inject code.",
            'GetProcAddress': "Top 55 - Retrieves the address of a function in a DLL loaded into memory. Used to import functions from other DLLs in addition to the functions imported in the PE file header.",
            'GetStartupInfo': "Top 55 - Retrieves a structure containing details about how the current process was configured to run, such as where the standard handles are directed.",
            'GetStdHandle': "Top 55 - Retrieves a handle to the specified standard device (standard input, standard output, or standard error).",
            ...
            'GetTickCount': "Top 55 - Retrieves the number of milliseconds since bootup. This function is sometimes used to gather timing information as an anti-debugging technique. GetTickCount is often added by the compiler and is included in many executables, so simply seeing it as an imported function provides little information.",
            'GetVersion': "Top 55 - Retrieves the operating system version.",
            ...
            'GetVersionExA': "Top 55 - Retrieves the operating system version.",
            ...
            'HeapAlloc': "Top 55 - Allocates a block of memory from a heap. The allocated memory is not movable.",
            ...
            'InitializeCriticalSection': "Top 55 - Initializes a critical section object.",
            ...
            'LeaveCriticalSection': "Top 55 - Releases ownership of the specified critical section object.",
            'LoadLibrary': "Top 55 - Loads a DLL into a process that may not have been loaded when the program started. Imported by nearly every Win32 program.",
            ...
            'LocalAlloc': "Top 55 - Allocates the specified number of bytes from the heap.",
            'LocalFree': "Top 55 - Frees the specified local memory object and invalidates its handle.",
            ...
            'lstrlenA': "Top 55 - Determines the length of the specified string.",
            ...
            'MessageBox': "Top 55 - Displays a modal dialog box that contains a system icon, a set of buttons, and a brief application-specific message, such as status or error information. The message box returns an integer value that indicates which button the user clicked.",
            ...
            'MultiByteToWideChar': "Top 55 - Maps a character string to a UTF-16 (wide character) string. The character string is not necessarily from a multibyte character se.",
            ...
            'RaiseException': "Top 55 - Raises an exception in the calling thread.",
            'ReadFile': "Top 55 - Reads data from the specified file or input/output (I/O) device. Reads occur at the position specified by the file pointer if supported by the device.",
            ...
            'RegCloseKey': "Top 55 - Closes a handle to the specified registry key.",
            ...
            'RegOpenKeyEx': "Top 55 - Opens the specified registry key. Note that key names are not case sensitiv.",
            'RegQueryValueEx': "Top 55 - Retrieves the type and data for the specified value name associated with an open registry key.",
            ...
            'RtlUnwind': "Top 55 - Initiates an unwind of procedure call frames.",
            ...
            'SetFilePointer': "Top 55 - Moves the file pointer of the specified file.",
            ...
            'Sleep': "Top 55 - Suspends the execution of the current thread until the time-out interval elapses.",
            ...
            'TerminateProcess': "Top 55 - Terminates the specified process and all of its threads.",
            ...
            'TlsGetValue': "Top 55 - Retrieves the value in the calling thread's thread local storage (TLS) slot for the specified TLS index. Each thread of a process has its own slot for each TLS index.",
            'TlsSetValue': "Top 55 - Stores a value in the calling thread's thread local storage (TLS) slot for the specified TLS index. Each thread of a process has its own slot for each TLS index.",
            'Toolhelp32ReadProcessMemory': "Used to read the memory of a remote process.",
            'UnhandledExceptionFilter': "Top 55 - An application-defined function that passes unhandled exceptions to the debugger, if the process is being debugged.",
            ...
            'VirtualAlloc': "Top 55 - Reserves, commits, or changes the state of a region of pages in the virtual address space of the calling process. Memory allocated by this function is automatically initialized to zero.",
            ...
            'VirtualFree': "Top 55 - Releases, decommits, or releases and decommits a region of pages within the virtual address space of the calling process.",
            'VirtualProtect': "Top 55 - Changes the protection on a region of committed pages in the virtual address space of the calling process.",
            ...
            'WaitForSingleObject': "Top 55 - Waits until the specified object is in the signaled state or the time-out interval elapses.",
            'WideCharToMultiByte': "Top 55 - Used to convert a Unicode string into an ASCII string.",
            ...
            'WriteFile': "Top 55 - Writes data to the specified file or input/output (I/O) device.",
